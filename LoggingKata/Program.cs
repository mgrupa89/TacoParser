...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            logger.LogInfo("Read all lines, stored an IEnum of Point.Locations in locations");
            ...
            Console.WriteLine("the two Taco Bells that are the furthest away from each other are:");
